...
opt.manualSeed = 666999 # random.randint(1, 10000) # fix seed
...
# rescale the image, convert to tensor ([0.0, 1.0]) and convert to [-1.0, 1.0]
...
loss_d = np.zeros(len(dataloader))
